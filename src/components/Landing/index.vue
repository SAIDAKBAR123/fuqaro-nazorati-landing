...
<script>
// const bannerPath = require("../../assets/Images/back.png");
export default {
  data () {
    return {
      // bannerPath,
...
.triangle-1 {
  ...
  border-left: 14px solid rgba(52, 166, 150, 0.3);
}
...
.triangle-2 {
  ...
  border-bottom: 14px solid rgba(52, 166, 150, 0.3);
}
...
@media (min-width: 1031px) and (max-width: 1131px) {
  .header-chat {
    top: 51px;
    right: 19px;
  }
